class GameBoyAdvanceKeypad {
    constructor() {
        ...
        this.KEYCODE_A = 74; // J (A)
        this.KEYCODE_B = 75; // K (B)
        this.KEYCODE_L = 76; // L (L)
        this.KEYCODE_R = 186; // ; (R)
        this.KEYCODE_JUMP = 32; // Space (Jump)
        ...
        this.GAMEPAD_L = 4;
        this.GAMEPAD_R = 5;
        this.GAMEPAD_JUMP = 2; // Assuming a jump button
        ...
        this.R = 8;
        this.L = 9;
        this.JUMP = 10; // Adding a jump button
    ...
    gamepadHandler(gamepad) {
        ...
        if (gamepad.buttons[this.GAMEPAD_JUMP] > this.GAMEPAD_THRESHOLD) {
            value |= 1 << this.JUMP;
        }
    ...
    // keyId is ["A", "B", "SELECT", "START", "RIGHT", "LEFT", "UP", "DOWN", "R", "L", "JUMP"]
    initKeycodeRemap(keyId) {
        // Ensure valid keyId
        var validKeyIds = ["A", "B", "SELECT", "START", "RIGHT", "LEFT", "UP", "DOWN", "R", "L", "JUMP"];
